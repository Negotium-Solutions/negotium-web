...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Negotium Just Walk Out Technology</title>
    ...
    <body>
            ...
            <main>
              ...
              <div class="text-white pb-3 mb-3 text-center">
                <h3>Negotium Just Walk<br />Out Technology</h3>
                <small>&nbsp;</small>
                <video class="mt-3 pt-3" width="640" height="360" autoplay controls loop>
                  ...
                  @if(Session::has('flash_success'))
                    ...
                    @csrf
                      ...
                      <div class="col-auto">
                          ...
                          <input type="hidden" name="page" value="Negotium Just Walk Out Technology" />
                      </div>
                      </div>
